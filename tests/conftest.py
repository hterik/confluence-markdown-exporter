...
def _confluence_mock() -> MagicMock:
    ...
    def _get(*args: object, **kwargs: object) -> None:  # noqa: ARG001
        # Prevent _descendants() getting stuck iterating over `next_path`
        # being infinite series of `MagicMock`
        msg = "Unmocked get-call"
